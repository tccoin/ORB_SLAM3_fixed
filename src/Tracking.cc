...
namespace ORB_SLAM3
{
    ...
    void Tracking::Track()
    {
        ...
        if (mState == NOT_INITIALIZED)
        {
            ...
            {
                std::cout << "fail to initialized" << std::endl;
    ...
    void Tracking::MonocularInitialization()
    {
        ...
        if (!mbReadyToInitializate)
        {
            ...
            {
                std::cout << "Set Reference Frame" << std::endl;
        ...
        else
        {
            if (((int)mCurrentFrame.mvKeys.size() <= 100) || ((mSensor == System::IMU_MONOCULAR) && (mLastFrame.mTimeStamp - mInitialFrame.mTimeStamp > 1.0)))
            {
                ...
                std::cout << "mbReadyToInitializate = false" << std::endl;
            ...
            bool reconstruct = mpCamera->ReconstructWithTwoViews(mInitialFrame.mvKeysUn, mCurrentFrame.mvKeysUn, mvIniMatches, Tcw, mvIniP3D, vbTriangulated);
            std::cout << "reconstruct: " << reconstruct << std::endl;
            if (reconstruct)
            {
